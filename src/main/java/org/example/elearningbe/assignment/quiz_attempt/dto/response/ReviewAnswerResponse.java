...
@NoArgsConstructor
@AllArgsConstructor
public class ReviewAnswerResponse implements Serializable {
    @Serial
    ...
    private Long correctChoiceId;        // đáp án đúng (id)
    private String correctChoiceContent; // đáp án đúng (nội dung)
}
